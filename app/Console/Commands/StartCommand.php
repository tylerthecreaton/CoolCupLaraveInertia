...
class StartCommand extends Command implements CommandInterface
{
    ...
    // protected array $aliases = ['joindo'];
    ...
    public function handle()
    {
        ...
        if ($this->argument('age', 0) >= 18) {
            $this->replyWithMessage(['text' => 'Congrats, You are eligible to buy premimum access to our membership!, our chat id is ' . $this->getUpdate()->getMessage()->chat->id]);
        } else {
