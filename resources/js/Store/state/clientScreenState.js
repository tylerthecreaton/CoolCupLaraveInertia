...
export const clientScreenReducer = (
    state = initialClientScreenState,
    action
) => {
    let newState;
    ...
    switch (action.type) {
        case "TOGGLE_CLIENT_SCREEN": {
            ...
            clientScreenChannel.postMessage({
                type: "UPDATE_CLIENT_SCREEN_STATE",
                payload: newState,
            });
            return newState;
        }
