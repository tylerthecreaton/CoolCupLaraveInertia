...
export default function Edit({ auth, transformer, ingredients, consumables }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        ingredient_id: transformer.ingredient_id,
        consumable_id: transformer.consumable_id,
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <Card>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            <div>
                                <div className="mb-2 block">
                                    <Label htmlFor="ingredient_id" value="Ingredient" />
                                </div>
                                <Select
                                    id="ingredient_id"
                            ...
                            <div>
                                <div className="mb-2 block">
                                    <Label htmlFor="consumable_id" value="Consumable" />
                                </div>
                                <Select
                                    id="consumable_id"
